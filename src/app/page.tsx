...
const HERO_SLIDES = [
  { url: 'https://nitsri.ac.in/upload/slide-1-new.jpg', title: 'NIT Srinagar Campus', desc: 'The heart of academic excellence in Hazratbal.' },
  { url: 'https://nitsri.ac.in/SliderPhoto/2064.jpg', title: 'Information Technology', desc: 'Modern labs for the future innovators.' },
  { url: 'https://nitsri.ac.in/SliderPhoto/3665.jpg', title: 'CSE Department', desc: 'Where logic meets creativity.' },
  { url: 'https://nitsri.ac.in/SliderPhoto/4860.jpg', title: 'Mechanical Engineering', desc: 'Hands-on training with advanced machinery.' },
  { url: 'https://nitsri.ac.in/SliderPhoto/3225.jpg', title: 'Electrical Engineering', desc: 'Powering the next generation.' },
  { url: 'https://nitsri.ac.in/SliderPhoto/3189.jpg', title: 'Civil Engineering', desc: 'Building the foundations of tomorrow.' },
];
      ...
      <section className="relative h-[85vh] min-h-[600px] overflow-hidden">
        ...
        >
                  ...
                  <div className="container mx-auto px-4 relative z-10 h-full flex flex-col justify-center">
                    <div className="max-w-3xl space-y-6 animate-in fade-in slide-in-from-left-5 duration-700">
                      ...
                      <p className="text-lg md:text-xl text-muted-foreground max-w-xl font-medium">
                        {slide.desc} Find notes, old papers, and assignments shared by fellow NITians.
                      </p>
          ...
          <div className="absolute bottom-10 right-20 flex gap-4 z-20">
            <CarouselPrevious className="relative left-0 translate-y-0 h-12 w-12 bg-background/50 hover:bg-primary hover:text-white border-primary/20" />
            <CarouselNext className="relative right-0 translate-y-0 h-12 w-12 bg-background/50 hover:bg-primary hover:text-white border-primary/20" />
          </div>
        </Carousel>
      </section>
      ...
      <section className="container mx-auto px-4 -mt-24 relative z-20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            <div key={i} className="bg-card backdrop-blur-md p-6 rounded-2xl flex items-center gap-6 border border-primary/10 shadow-2xl hover:border-primary/40 transition-all group">
      ...
      <section className="container mx-auto px-4 space-y-8">
        <div className="flex justify-between items-end">
          <div className="space-y-2">
            <h2 className="text-3xl font-bold tracking-tight">Search by Branch</h2>
            <p className="text-muted-foreground text-sm">Pick your department to see specific notes.</p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-6">
              ...
              <h2 className="text-4xl md:text-6xl font-bold tracking-tight text-primary">AI Study Buddy.</h2>
              <p className="text-lg text-muted-foreground font-medium">
                Our AI helps you learn faster. It can make short notes from long documents or help you practice for exams.
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  { title: 'Quick Summaries', desc: 'Get main points fast.', icon: Sparkles },
                  { title: 'Exam Questions', desc: 'Practice with mock tests.', icon: Cpu },
                ].map((item, i) => (
            ...
            <div className="relative aspect-video rounded-3xl overflow-hidden shadow-2xl border-4 border-primary/10 group">
              <Image 
        ...
        <div className="bg-primary rounded-[3rem] p-12 md:p-20 text-center space-y-8 relative overflow-hidden shadow-2xl">
          ...
          <div className="max-w-3xl mx-auto space-y-6 relative z-10">
            ...
            <p className="text-lg md:text-2xl text-white/90 font-medium leading-relaxed">
              Your notes can help someone else pass their exams. Upload your work and be a hero at NIT Srinagar!
            </p>
