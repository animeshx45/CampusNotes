...
const BRANCH_IMAGE_MAP: Record<string, string[]> = {
  ...
  'Electronics & Communication Engineering': ['branch-ece-official', 'branch-ece-1', 'branch-ece-2', 'hero-campus-1'],
  'Metallurgical & Materials Engineering': ['branch-meta-official', 'branch-meta-1', 'branch-meta-2', 'hero-campus-2']
};
