      ...
      <Card className="w-full max-w-md shadow-2xl border-none rounded-[2rem] overflow-hidden">
        ...
        <CardContent className="space-y-6 p-8">
          <div className="grid grid-cols-1 gap-4">
            <Button variant="outline" className="w-full rounded-xl border-primary/10 hover:bg-secondary h-12 font-bold" onClick={handleGoogleLogin}>
          ...
          <div className="relative text-center">
            ...
            <span className="relative bg-background px-4 text-[10px] text-muted-foreground uppercase font-black tracking-widest">Or use email</span>
          </div>
