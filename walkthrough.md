...
* **Folder Note Google Drive Layout (Table view) & Preview Removal:**
  ...
  * Configured `downloadFileUrl` in [page.tsx](file:///c:/Users/rajur/Downloads/project%20(1)/src/app/material/[id]/page.tsx#L923) to automatically intercept legacy dev-mode URLs starting with `/uploads/` and dynamically rewrite them to the `/api/upload?id=...` endpoint. This prevents browser navigation/404 errors when downloading folder files uploaded prior to the route modification.
